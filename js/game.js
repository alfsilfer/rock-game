var Game = {
  ...
  detectObstacles: function() {
    ...
    for (i = 0; i < this.obstacles.arrObs.length; i++) {
      cond1 = this.players.player.x + this.players.player.width >= this.obstacles.arrObs[i].x;
      cond2 =
        this.obstacles.arrObs[i].x + this.obstacles.arrObs[i].width >=
        this.players.player.x;
      cond3 = this.players.player.y + this.players.player.height >= this.obstacles.arrObs[i].y;
      cond4 =
        this.obstacles.arrObs[i].y + this.obstacles.arrObs[i].height >=
        this.players.player.y + this.players.player.height;

      if (cond1 && cond2 && cond3 && cond4) {
        this.players.player.y = this.obstacles.arrObs[i].y - this.players.player.height;
  ...
  detectObstaclesP2: function() {
    var cond1, cond2, cond3, cond4;
    for (i = 0; i < this.obstacles.arrObs.length; i++) {
      cond1 = this.players.player2.x + this.players.player2.width >= this.obstacles.arrObs[i].x;
      cond2 =
        this.obstacles.arrObs[i].x + this.obstacles.arrObs[i].width >=
        this.players.player2.x;
      cond3 =
        this.players.player2.y + this.players.player2.height >= this.obstacles.arrObs[i].y;
      cond4 =
        this.obstacles.arrObs[i].y + this.obstacles.arrObs[i].height >=
        this.players.player2.y + this.players.player2.height;

      if (cond1 && cond2 && cond3 && cond4) {
        this.players.player2.y = this.obstacles.arrObs[i].y - this.players.player2.height;
